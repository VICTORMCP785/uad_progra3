...
/* */
CAppX::CAppX() :
	CAppX(CGameWindow::DEFAULT_WINDOW_WIDTH, CGameWindow::DEFAULT_WINDOW_HEIGHT) // C++11 ability to call one constructor from another
{
...
bool CAppX::load3DModel(const char * const filename)
{
...
/* */
void CAppX::unloadCurrent3DModel()
{
	if (m_p3DModel != nullptr)
	{
...
void CAppX::onF2(int mods)
{
	...
	ofn.hwndOwner = NULL;
	ofn.lpstrFilter = L" X Files\0*.x\0 Fbx Files\0*.fbx\0 Stl Files\0*.stl\0 3DS Files\0*.3ds\0 All files\0*.*\0";
...
/* */
void CAppX::moveCamera(float direction)
{
